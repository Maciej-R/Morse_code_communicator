...
class SignalProcessor(wpm: Float, freq: Short): Parameters() {
    ...
    companion object {
        ...
        fun getInstance(wpm: Float = Parameters.default_wpm, freq: Short = Parameters.default_frequency): SignalProcessor {
            if (this.instance != null)
                return this.instance!!
            return SignalProcessor(wpm, freq)
        }
    }
